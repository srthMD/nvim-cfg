...
vim.api.nvim_set_keymap(
  "n",
  "<leader>uD",
  ":call v:lua.toggle_diagnostic_underline()<CR>",
...
vim.keymap.set("n", "<Leader>dB", function()
  ...
  end) { desc = "Add Conditional Breakpoint", silent = true }
end)
wk.add {
...
vim.api.nvim_set_keymap("n", "<F1>", "<cmd>DapStepOver<CR>", { noremap = true, silent = true, desc = "Step Over" })

vim.api.nvim_set_keymap("n", "<F2>", "<cmd>DapStepInto<CR>", { noremap = true, silent = true, desc = "Step Into" })

vim.api.nvim_set_keymap("n", "<F3>", "<cmd>DapStepOut<CR>", { noremap = true, silent = true, desc = "Step Out" })
...
vim.api.nvim_set_keymap(
  "n",
  "<leader>tt",
  "<cmd>ToggleTerm size=20 dir=" .. vim.fn.getcwd() .. " <CR>",
...
vim.keymap.set("n", "<Leader>bD", function()
  ...
  local char = vim.fn.getcharstr()
  local bufnr = buflist._picker_labels[char]
  if bufnr then vim.api.nvim_buf_delete(bufnr, { unload = true }) end
  buflist._show_picker = false
  vim.cmd.redrawtabline()
end, {
